...
mcp = FastMCP(
    ...
    instructions=(
        "A human-reviewed directory of apps, sites, and projects built with Bend 2. "
...
def _authenticate_profile() -> Profile:
    ...
    if profile is None:
        raise PermissionError(
            "Missing or invalid Built with Bend MCP credentials. "
...
@mcp.tool(
    name="get_user_info",
    description=(
        "Return safe account and profile details for the authenticated Built with Bend user."
    ),
)
