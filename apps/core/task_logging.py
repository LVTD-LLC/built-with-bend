...
from built_with_bend.logging_utils import bind_log_context, reset_log_context

logger = logging.getLogger(__name__)

_TASK_STARTED_AT: ContextVar[tuple[float, ...]] = ContextVar(
    "built_with_bend_task_started_at",
    default=(),
)
_TASK_CONTEXT_TOKENS: ContextVar[tuple[Token, ...]] = ContextVar(
    "built_with_bend_task_context_tokens",
    default=(),
)
...
@receiver(pre_execute, dispatch_uid="built_with_bend.bind_task_logging_context")
...
@receiver(
    ...
    dispatch_uid="built_with_bend.log_task_completion",
)
