---
title: User API
description: Use the Built with Bend user endpoint to verify API access and inspect safe profile details.
keywords: Built with Bend API, user API, profile API
---
