...
from built_with_bend.sitemaps import BlogSitemap, sitemaps
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"robots": "none"}, False),
        ({"canonical_url": "https://other.example/original"}, False),
    ],
)
def test_blog_sitemap_uses_markdown_posts(blog_posts_dir, metadata, eligible):
    write_post(
        blog_posts_dir,
        "sitemap-post",
        {
