...
from built_with_bend.logging_utils import build_service_resource_attributes
from built_with_bend.posthog_logging import (
...
from built_with_bend import settings
from built_with_bend.posthog_logging import PostHogLoggingHandler
...
assert "posthog" in settings.LOGGING["loggers"]["built_with_bend"]["handlers"]
