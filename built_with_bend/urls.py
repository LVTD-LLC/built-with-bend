"""built_with_bend URL Configuration
...
from apps.directory.api import api as directory_api
...
from built_with_bend.sitemaps import sitemaps

handler404 = "apps.pages.error_views.page_not_found"

urlpatterns = [
    path("admin/", admin.site.urls),
    path("api/v1/", directory_api.urls),
