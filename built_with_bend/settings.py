"""
Django settings for built_with_bend project.
...
DEFAULT_SERVICE_NAME = (
    "built_with_bend-worker" if APP_PROCESS_TYPE == "worker" else "built_with_bend-web"
)
...
# Public ownership proof, created by the post-generation hook and tracked in git.
...
POSTHOG_SERVICE_NAME = env("POSTHOG_SERVICE_NAME", default="built_with_bend")
...
ALLOWED_HOSTS = [SITE_HOST, "localhost", "127.0.0.1"] + env.list("EXTRA_ALLOWED_HOSTS", default=[])
...
MIDDLEWARE = [
    ...
    "built_with_bend.logging_utils.RequestLogContextMiddleware",
...
if DATABASE_URL:
    ...
    POSTGRES_DB = env("POSTGRES_DB", default="built_with_bend")
    POSTGRES_USER = env("POSTGRES_USER", default="built_with_bend")
...
folder_name = env("AWS_S3_BUCKET_NAME", default=f"built-with-bend-{ENVIRONMENT}")
...
ALLOW_SIGNUPS = env.bool("ALLOW_SIGNUPS", default=False)
ACCOUNT_FORMS = {
    "signup": "apps.core.forms.CustomSignUpForm",
    "login": "apps.core.forms.CustomLoginForm",
}
ACCOUNT_ADAPTER = "built_with_bend.adapters.CustomAccountAdapter"
if ENVIRONMENT != "dev":
...
SOCIALACCOUNT_ADAPTER = "built_with_bend.adapters.CustomSocialAccountAdapter"
...
ANYMAIL = {
    ...
    "MAILGUN_SENDER_DOMAIN": env(
        ...
        default="mg.built_with_bend.app",
    ),
}
DEFAULT_FROM_EMAIL = env(
    "DEFAULT_FROM_EMAIL",
    default=("LVTD, LLC from Built with Bend <hello@built_with_bend.app>"),
)
SERVER_EMAIL = env(
    "SERVER_EMAIL",
    default=("Built with Bend Errors <error@built_with_bend.app>"),
)
...
LOCAL_INSTANCE_ID = env("LOCAL_INSTANCE_ID", default="built_with_bend")
...
if USE_EXISTING_TEST_DATABASE:
    CACHES["default"] = {
        ...
        "LOCATION": "built_with_bend-pgsandbox-tests",
    }
...
LOGGING = {
    ...
    "formatters": {
        "console": {
            "()": "built_with_bend.logging_utils.ConsoleFormatter",
        },
        "json": {
            "()": "built_with_bend.logging_utils.JsonFormatter",
            "service_name": SERVICE_NAME,
            "service_namespace": "built_with_bend",
    ...
    "filters": {
        "request_context": {
            "()": "built_with_bend.logging_utils.RequestContextFilter",
        },
        "require_debug_false": {
...
if POSTHOG_LOGS_ACTIVE:
    LOGGING["handlers"]["posthog"] = {
        "()": "built_with_bend.posthog_logging.PostHogLoggingHandler",
        "filters": ["request_context"],
    ...
    for application_logger in ("apps", "built_with_bend"):
...
# Directory boundaries retained across regeneration.
