...
keywords: Built with Bend, Apprise, Slack, notifications, alerts
author: LVTD, LLC
---
...
2. Create a saved config key for this app, for example `built_with_bend`.
...
APPRISE_CONFIG_KEY=built_with_bend
