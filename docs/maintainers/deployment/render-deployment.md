---
title: Deploying Built with Bend to Render
description: Learn how to deploy Built with Bend on Render.
keywords: Built with Bend, deployment, render, self-hosting
author: LVTD, LLC
---

[![Deploy to Render](https://render.com/images/deploy-to-render-button.svg)](https://render.com/deploy?repo=https://github.com/LVTD-LLC/built-with-bend)
...
Before deploying, you need to configure environment variables. See the [Environment Variables](environment-variables.md) guide for detailed information about all configuration options.

Refer to the [Environment Variables](environment-variables.md) guide for the complete list of required and optional variables.
